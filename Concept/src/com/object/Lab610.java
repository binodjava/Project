...
public class Lab610 {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		System.out.println(h1 == h2);//false, both member class var pointing its own object, no address is common
		System.out.println(h1.hai == h2.hai);//false, both address are different
		h1.show();
		h2.show();
		h2.y = 11;
		h2.hai.x = 22;
