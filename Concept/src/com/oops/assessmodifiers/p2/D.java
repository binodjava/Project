...
class E {
	public void showE() {
		...
		//System.out.println(aobj.b);// Default [package level only]
		//System.out.println(aobj.c);// Protected [outside the package in sub
									// class only, not in no-sub class]
		System.out.println(aobj.d);// Public [Anywhere]
	}
}